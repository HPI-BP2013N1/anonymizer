...
CREATE TABLE ORIGINAL.PRODUCTSALES ( SALEID INT, PRODUCTID INT, PRIMARY KEY(SALEID) );
CREATE TABLE ORIGINAL.PRODUCTBUYER ( SALEID INT, BUYERNAME VARCHAR(60), PRIMARY KEY(SALEID) );
CREATE TABLE ORIGINAL.BUYERDETAILS ( SALEID INT, BUYERNAME VARCHAR(60), CUSTOMERNO INT, PRIMARY KEY(SALEID, BUYERNAME) );
